    ...
    <div id="portlist">
      ...
      <div className="list__wrap">
        <div className="list__cate">
          <span
            className={selectedTab === "react" ? "active" : ""}
          ...
          <span
            className={selectedTab === "vue" ? "active" : ""}
            onClick={() => handleTabChange("vue")}
          >
            Vue
          </span>
          <span
            className={selectedTab === "vite" ? "active" : ""}
            onClick={() => handleTabChange("vite")}
          >
            Vite
          </span>
          <span
            className={selectedTab === "php" ? "active" : ""}
            onClick={() => handleTabChange("php")}
          >
            Php
          </span>
          <span
            className={selectedTab === "javascript" ? "active" : ""}
